...
# Form implementation generated from reading ui file 'from_circle.ui'
#
...
class FormCircle(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.text_draw_a_circle.setStyleSheet("background-color: rgb(206, 203, 198); \n"
        ...
        self.ButtonSaveCircle.setStyleSheet("QPushButton {\n"
        ...
        self.text_x_coord.setStyleSheet("background-color: rgb(206, 203, 198); \n"
                                        "font: 87 italic 10pt \"Segoe UI Black\";\n"
                                        "color: rgb(61, 61, 61);\n"
                                        "border-radius: 10px; \n"
                                        "")
        ...
        self.text_y_coord.setStyleSheet("background-color: rgb(206, 203, 198); \n"
                                        "font: 87 italic 10pt \"Segoe UI Black\";\n"
                                        "color: rgb(61, 61, 61);\n"
                                        "border-radius: 10px; \n"
                                        "")
        ...
        self.text_radius.setStyleSheet("background-color: rgb(206, 203, 198); \n"
                                       "font: 87 italic 10pt \"Segoe UI Black\";\n"
                                       "color: rgb(61, 61, 61);\n"
                                       "border-radius: 10px; \n"
                                       "")
        ...
        self.text_line_size.setStyleSheet("background-color: rgb(206, 203, 198); \n"
                                          "font: 87 italic 10pt \"Segoe UI Black\";\n"
                                          "color: rgb(61, 61, 61);\n"
                                          "border-radius: 10px; \n"
                                          "")
        ...
        self.TextUserX.setStyleSheet("background-color: rgba(206, 203, 198, 0.5); \n"
        ...
        self.TextUserY.setStyleSheet("background-color: rgba(206, 203, 198, 0.5); \n"
                                     "font: 87 italic 16pt \"Segoe UI Black\";\n"
                                     "color: rgb(61, 61, 61);\n"
                                     "border-radius: 10px; \n"
                                     "")
        ...
        self.TextUserR.setStyleSheet("background-color: rgba(206, 203, 198, 0.5); \n"
                                     "font: 87 italic 16pt \"Segoe UI Black\";\n"
                                     "color: rgb(61, 61, 61);\n"
                                     "border-radius: 10px; \n"
                                     "")
        ...
        self.TextUserL.setStyleSheet("background-color: rgba(206, 203, 198, 0.5); \n"
                                     "font: 87 italic 16pt \"Segoe UI Black\";\n"
                                     "color: rgb(61, 61, 61);\n"
                                     "border-radius: 10px; \n"
                                     "")
    ...
    def save_circle(self):
        try:
            if (int(self.TextUserX.text()) >= 0 and int(self.TextUserY.text()) >= 0 and int(self.TextUserR.text()) >= 1
                ...
                list_data = [int(self.TextUserX.text()), int(self.TextUserY.text()), int(self.TextUserR.text()), int(self.TextUserL.text())]
